...
#ALLOWED_HOSTS = [h.strip() for h in os.getenv("DJANGO_ALLOWED_HOSTS", "127.0.0.1,localhost,10.0.2.2,192.168.20.9").split(",")]
...
#CORS_ALLOWS_CREDENTIALS = True #Delete this later
